      ...
      <div className="bg-white rounded-lg shadow-xl max-w-6xl w-full max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-900">Predictive Network Analysis</h2>
              <p className="text-sm text-gray-600">ML-based pattern recognition and issue prediction</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          {loading && (
            <div className="text-center py-12">
              ...
              <p className="text-gray-600">Analyzing patterns and predicting issues...</p>
            </div>
          )}
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-r from-purple-50 to-blue-50 border border-purple-200 rounded-lg p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-1">Overall Risk Assessment</h3>
                    ...
                    {prediction.similarPatterns.map((pattern, idx) => (
                      <div key={idx} className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                        <div className="flex justify-between items-start mb-2">
                          <h4 className="font-semibold text-blue-900">{pattern.patternName}</h4>
              ...
              {aiInsights && (
                <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
                  ...
                  <div className="text-purple-800 text-sm prose prose-sm">
                    {onPacketClick ? (
