  ...
  if (captures.length === 0) {
    return (
      <div className="bg-white rounded-lg shadow p-6 text-center">
        ...
        <h3 className="text-lg font-semibold text-gray-900 mb-2">No Captures to Compare</h3>
        <p className="text-gray-600">Upload multiple PCAP files to enable comparison</p>
      </div>
    );
  }
  ...
  if (captures.length === 1) {
    return (
      <div className="bg-white rounded-lg shadow p-6 text-center">
        ...
        <h3 className="text-lg font-semibold text-gray-900 mb-2">Upload Another Capture</h3>
        <p className="text-gray-600 mb-4">You need at least 2 captures to compare</p>
        <p className="text-sm text-gray-500">Currently loaded: <strong>{captures[0].name}</strong></p>
      </div>
    );
  }
      ...
      {comparison && (
        <div className="bg-gradient-to-br from-blue-50 to-purple-50 border border-blue-200 rounded-lg p-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-lg font-semibold text-gray-900">AI Comparison Results</h3>
          </div>
          ...
          <div className="mt-4 pt-4 border-t border-blue-200">
            <p className="text-xs text-gray-600">
              Compared: <strong>{captures[selectedBefore].name}</strong> vs <strong>{captures[selectedAfter].name}</strong>
            </p>
          </div>
        </div>
      )}
