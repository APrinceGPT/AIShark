...
export default function Home() {
  ...
  const handleGoHome = useCallback(() => {
    ...
    if (allPackets.length > 0) {
      const message = user 
        ? 'Are you sure you want to return to the homepage? Your current analysis will be lost. Make sure to save your session first!'
        : 'Are you sure you want to return to the homepage? Your current analysis will be lost. Sign in to save your analysis before leaving.';
      
      if (window.confirm(message)) {
        handleNewUpload();
      }
    }
  }, [allPackets.length, user, handleNewUpload]);
